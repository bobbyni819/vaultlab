...
2. **No silent failures.** Every audit check writes to the artifact's manifest. Every refusal logs the reason. The user can always answer: "what did vaultlab check, what passed, what failed?"

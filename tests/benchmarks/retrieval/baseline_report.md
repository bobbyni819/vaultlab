# Retrieval Benchmark v0 — `tfidf` backend recall@k
...
- Backend: `vaultlab.kb.semantic_search.search` (backend=`tfidf`, default subdirs)
...
| ✅ | `10.1084/jem.20212434` | 3 | Low IL-12 concentrations are sufficient to induce expansion of human NK cells.… |

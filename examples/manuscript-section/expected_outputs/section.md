...
We analysed spatial transcriptomics data from 12 NSCLC donors to test
...
on shared marker programs (Figure 1; see `fig1_niche_heatmap.png`). Niche identity was reproducible
...
Notably, two niches — the tumour-stromal interface
(N4) and the tertiary-lymphoid-structure niche (N7) — were detected in
every donor analysed, while the rare hypoxic-core niche (N8) appeared
in only 4 of 12 donors. We characterised the cellular composition of
...
sections (Figure 2; see `fig2_cd8_vs_n7.png`). Donors with elevated N7 prevalence showed 2.4-fold

...
When the migration commits land, the intended public surface (per `docs/architecture.md`) is three benchmark suites:
...
- [`INSPIRATIONS.md`](../../../INSPIRATIONS.md) — where the deterministic-vs-LLM evaluation pattern is sourced and where new benchmark lineage must be recorded.

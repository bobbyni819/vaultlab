...
vaultlab/                        # The Python package
  ...
  runner/                        # ClaudeCodeRunner; runner/meetings.py (Meeting, Agenda, Mode, Role); reflection loop
  ...
  stats/                         # PLANNED — de/power/effect/blind wrappers; currently a placeholder (descriptive-only stats live in analysis/stats.py)
